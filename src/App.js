...
function App() {
  return (
    <div className=" container w-full h-full mx-auto my-4">
      {/* header */}
      <div className="w-full h-full flex items-center justify-between">
        <div className="flex items-end justify-center gap-5">
          <img className="h-[50px] w-[50px]" src="/logo.svg" />
      ...
      <div className="items-center flex justify-center  gap-9 ">
        <div className="">
          <h1 className="text-6xl font-bold pb-16">We safeguard</h1>
          <h1 className="text-4xl font-bold pb-16">The environment.</h1>
          <p className="w-96  font-bold text-lx ">Over the past several decades, as the world has increasingly warmed,
            so has its potential to burn.</p>
        </div>
        <div><img className="w-[900px] h-[800px]" src="./forest.svg"></img></div>
      </div>
